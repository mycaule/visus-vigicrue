...
},{"./helpers/bind":57,"is-buffer":405}],54:[function(require,module,exports) {
...
},{"./enhanceError":403}],361:[function(require,module,exports) {
'use strict';
...
},{"./createError":365}],362:[function(require,module,exports) {
'use strict';
...
},{"./../utils":55}],363:[function(require,module,exports) {
'use strict';
...
},{"./../utils":55}],364:[function(require,module,exports) {
'use strict';
...
},{"./../utils":55}],366:[function(require,module,exports) {
'use strict';
...
},{"./../utils":55}],244:[function(require,module,exports) {
'use strict';
...
},{"./../utils":55,"./../core/settle":361,"./../helpers/buildURL":362,"./../helpers/parseHeaders":363,"./../helpers/isURLSameOrigin":364,"../core/createError":365,"./../helpers/btoa":366,"./../helpers/cookies":367}],245:[function(require,module,exports) {
'use strict';
...
},{"../utils":55}],56:[function(require,module,exports) {
...
var struct = S.superstruct({
  types: {
    url: isUrl,
    simple: function simple(v) {
      return v === 'simple';
    },
    iso: function iso(v) {
      return v === 'iso';
...
var VolumeUnit = struct.enum(['H', 'Q']);
...
var Observations = struct({
  ...
  Serie: {
    ...
    Link: 'url',
    GrdSerie: VolumeUnit,
    ObssHydro: struct.union([[['number | string', 'number']], [{
      DtObsHydro: 'number | string',
      ResObsHydro: 'number'
    }]])
  }
...
var VigiError = struct([{
  error_msg: 'string'
}]);

var vigicrues = axios.create({
  baseURL: 'https://www.vigicrues.gouv.fr/services',
  timeout: 3000
});

var stations = function stations() {
  var GrdSerie = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'H';
  var FormatDate = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  var FormatSortie = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
  return vigicrues.get('/observations.json/', {
    params: { GrdSerie: GrdSerie, FormatDate: FormatDate, FormatSortie: FormatSortie }
  }).then(function (resp) {
    return struct.union([Stations, VigiError])(resp.data);
  });
};

var informations = function informations(CdStationHydro) {
  return vigicrues.get('/station.json/', {
    params: { CdStationHydro: CdStationHydro }
  }).then(function (resp) {
    return struct.union([Informations, VigiError])(resp.data);
  });
};

var observations = function observations(CdStationHydro) {
  var GrdSerie = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'H';
  var FormatDate = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
  var FormatSortie = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
  return vigicrues.get('/observations.json/index.php', {
    params: ReqParams({ CdStationHydro: CdStationHydro, GrdSerie: GrdSerie, FormatSortie: FormatSortie, FormatDate: FormatDate })
  }).then(function (resp) {
    var obs = Observations(resp.data);

    var _obs$Serie$ObssHydro = _toArray(obs.Serie.ObssHydro),
        first = _obs$Serie$ObssHydro[0],
        rest = _obs$Serie$ObssHydro.slice(1);
...
var previsions = function previsions(CdStationHydro) {
  var GrdSimul = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'H';
  var FormatDate = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
  var FormatSortie = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : undefined;
  return vigicrues.get('/previsions.json/index.php', {
    params: ReqParamsSimul({ CdStationHydro: CdStationHydro, GrdSimul: GrdSimul, FormatSortie: FormatSortie, FormatDate: FormatDate })
  }).then(function (resp) {
    var prevs = Previsions(resp.data);

    var _prevs$Simul$Prevs = _toArray(prevs.Simul.Prevs),
        first = _prevs$Simul$Prevs[0],
        rest = _prevs$Simul$Prevs.slice(1);
...
var bulletin = function bulletin(CdEntVigiCru) {
  return vigicrues.get('/bulletin.json/', {
    params: { CdEntVigiCru: CdEntVigiCru }
  }).then(function (resp) {
    return Bulletin(JSON.parse(resp.data.slice(0, -1).slice(1)));
  });
};
...
vigicrues.observations('F700000103', 'Q').then(function (res) {
  var observations = res.Serie.ObssHydro;
